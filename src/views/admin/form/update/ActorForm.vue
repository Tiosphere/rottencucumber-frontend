...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post("http://localhost:8080/api/admin/actor/update/"+ this.$route.params.slug, form)
                .then((res) => {
                    let data = res.data
                    console.log(data)
                    if(data.success) {
    ...
    beforeMount() {
        ...
        axios.get("http://backend.rottencucumber.tk/api/admin/actor/get/" + this.$route.params.slug)
            .then((res) => {
        ...
        <div class="modal-content">
            <div class="auth-header">
                <div class="auth-title">
                    <div class="title">Edit Actor</div>
                </div>
            </div>
                ...
                <form class="content " id="form" v-on:submit.prevent="submitForm" ref="accountForm">
                    <div class="hide-on-success">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" required placeholder="New Actor Name" :value="this.default_data.name">
                        </div>
                        <div class="form-group">

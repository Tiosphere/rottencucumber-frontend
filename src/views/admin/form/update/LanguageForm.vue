...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post("http://backend.rottencucumber.tk/api/admin/language/update/"+ this.$route.params.slug, form)
                .then((res) => {
                    let data = res.data
                    console.log(data)
                    if(data.success) {
                ...
                <form class="content " v-on:submit.prevent="submitForm" ref="LanguageForm">
                    <div class="hide-on-success">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" required placeholder="New Language">
                        </div>

...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post("http://backend.rottencucumber.tk/api/admin/genre/update/"+ this.$route.params.slug, form)
                .then((res) => {
                    let data = res.data
                    console.log(data)
                    if(data.success) {
    ...
    <div class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="content " v-on:submit.prevent="submitForm" ref="genreForm">
